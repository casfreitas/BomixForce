<div class="modal fade" id="edtAdmin" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header header_modal">
        <h5 class="modal-title fs-4" id="exampleModalLabel">EDITAR ADMINISTRADOR</h5>
        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">

        <!-- IMPEDE FINALIZAR CADASTRO CLICANDO NA TACLA 'ENTER' -> onkeydown="return event.key != 'Enter';" -->
        <form method="post" id="cad_admin" action="Controller/ControllerUsuarios.php?funcao=edit_admin" class="row g-3 needs-validation" onkeydown="return event.key != 'Enter';" novalidate>
          ...
          <div class="col-lg-12">
            ...
            <input list="browsers" type="text" class="form-control campo_form text-uppercase" id="nome_completo" name="nome_completo" disabled> <!-- readonly -->
          ...
          <div class="col-lg-12">
            ...
            <input type="text" class="form-control text-uppercase campo_form" id="usuario" name="usuario" placeholder="Usuário" disabled>
            <div class="invalid-feedback">Campo obrigatório</div>
          </div>

          <div class="col-lg-12">
            <!-- <label for="email" class="form-label">Email <span class="aste-red">*</span></label> -->
            <input type="text" class="form-control text-lowercase campo_form" id="email" name="email" placeholder="Email" required>
            <div class="invalid-feedback">Campo obrigatório</div>
          </div>
          ...
          <div class="col-12 text-end">
            <div class="modal-footer p-0 pt-3">
              ...
              <button type="submit" class="botao_vasado LoadEdtAdmin">Salvar</button>
            </div>
          </div>
        </form>
...
<script>
  // BOTAO LOAD
  document.querySelector('.LoadEdtAdmin').addEventListener('click', function() {
    var _this = this;
...
<script type="text/javascript">
  ...
  $('#edtAdmin').on('show.bs.modal', function(event) {
