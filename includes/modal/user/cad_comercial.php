<div class="modal fade" id="cadComercial" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header header_modal">
        <h5 class="modal-title fs-4" id="exampleModalLabel">CRIAR USUÁRIO COMERCIAL</h5>
        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">

        <!-- IMPEDE FINALIZAR CADASTRO CLICANDO NA TACLA 'ENTER' -> onkeydown="return event.key != 'Enter';" -->
        <form method="post" id="cad_admin" action="Controller/ControllerUsuarios.php?funcao=cad_comercial" class="row g-3 needs-validation" onkeydown="return event.key != 'Enter';" novalidate>
          ...
          <div class="col-12 text-end">
            <div class="modal-footer p-0 pt-3">
              ...
              <button type="submit" class="botao_vasado LoadCadComercial">Salvar</button>
            </div>
          </div>
        </form>
