...
<section class="px-2 px-sm-5">
  ...
  <div class="container-fluid main_paginas px-4 px-sm-5 py-5">
    ...
    <section class="campo_tabela">
      ...
      <div class="row row-cols-1 row-cols-md-2 row-cols-xl-3 g-lg-5 g-4 card_user">
        ...
        if ($_SESSION['us_grupo'] == '1') {
          ...
          $sql = "SELECT u.us_id, u.us_cnpj_cliente, u.us_cliente, u.us_last_login, u.us_nome_completo, u.us_usuario, u.us_email, u.us_nivel, u.us_status, u.us_grupo, u.us_data_entrada, e.us_fk, e.ue_setor, e.ue_cargo, e.ue_recno, e.ue_cliente, e.ue_cnpj, e.ue_permissao
                      FROM sys_tb_usuarios u
                      LEFT JOIN sys_tb_usuario_empresa e
                      ON e.us_fk = u.us_id
                      WHERE u.us_nivel != 1
                      AND u.us_id != '$usuario_logado'
                      ORDER BY u.us_nome_completo
                      ";
        }
        ...
        while ($row_user = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
          ...
          $id            = $row_user['us_id'];
          $cnpj_cliente  = $row_user['us_cnpj_cliente'];
        ...
        ?>
          ...
          <div class="col">
            <div class="card h-100">
              <div class="card-body">
                <h5 class="card-title"><?= $nome_completo ?></h5>
                <div class="row">
                ...
                <div class="row">
                  <div class="col-4"><strong>SETOR</strong></div>
                ...
                <div class="row">
                  ...
                  <div class="col"><span class="badge <?= $cor_grupo ?> p-2"><?= $papel[$grupo] ?></span></div>
                </div>
                <div class="row">
                  <div class="col-4"><strong>ACESSO</strong></div>
                  <div class="col"><?php if (isset($ultimo_login)) {
